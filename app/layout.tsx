...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${inter.variable} ${poppins.variable} font-sans antialiased min-h-screen bg-gradient-to-br from-evertwine-50 via-white to-evertwine-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800`}
      >
        <AuthProvider>
